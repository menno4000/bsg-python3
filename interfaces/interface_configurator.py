...
class InterfaceConfigurator:
    ...
    @staticmethod
    def get_interface(train_data_path,
                      vocab_file_path,
        ...
        z_dim = 100
        # the number of dimensions of the latent vectors
        # alpha = 0.001  # learning rate (19m de)
    #    alpha = 0.0007  # learning rate (2m en)
    # /alpha = 0.00005  # learning rate (1b en)
        ...
        i_model = IBSG(vocab=vocab, data_iterator=data_iterator, train_data_path=train_data_path,
                       ...
                       epochs=epochs, max_vocab_size=max_vocab_size, learning_rate=alpha, embedding_size=embedding_size)
