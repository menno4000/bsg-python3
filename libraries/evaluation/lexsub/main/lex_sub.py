import os, sys
import operator
from libraries.evaluation.lexsub.main.support import read_candidates, wf2ws, flatten, get_best_scores_for_candidates, conll_skip_sentence
from libraries.evaluation.lexsub.main.context_instance import ContextInstance
import numpy as np
...
def lex_sub(embeddings, input_type, target_words_vocab, context_words_vocab, output_path, candidates_file, conll_file,
    ...
    with open(test_file, 'r',encoding='utf-8',errors='ignore') as f: #python 3
