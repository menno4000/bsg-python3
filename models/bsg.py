...
from models.bword2vec import BWord2Vec
...
class BSG(BWord2Vec):
    ...
    def __build_model(self):
        ...
        self.embeddings_log_sigma = Embeddings("emb_output_log_sigma", self.vocab_size, varste_dim, init_type='bsg_log_sigmas')
        ...
        self.dense_sigma = Dense("dense_sigma", self.hidden_dim, varste_dim, init_type='xavier_uniform')
